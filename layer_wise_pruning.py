...
from utils.pruning_analysis import get_device, get_pruned_info, get_unpruned_info, extend_channels, AlexNet_General, calculate_last_conv_out_features, get_core_weights, reconstruct_weights_from_dicts, freeze_channels, fine_tuner, prune_model


def main():
    wandb.init(project='layerWisePruning', name='AlexNet_Prune_Run')
